...
const Cafescreen = () => {
  ...
  return (
    <div style={{textAlign: 'center', justifyContent: 'center'}}>
      ...
      <br/>
      <br/>
      <img id="logopic" style={{ width: '30%', height: 'auto', textAlign: 'center', justifyContent: 'center', marginTop: '-3%', marginBottom: '-3%'}} src="https://i.postimg.cc/vm6xs6d9/791-DAF1-D-A7-E1-40-DB-8-DA6-466-A903-DB44-F.jpg" alt="boutiquepic"/>
      <br/>
      <br/>
      <br/>
      <br/>
      ...
      <div className='demo' id='demo' style={{ backgroundColor: 'darkorange' }}>
          ...
          <div className='col-1'>
              <br />
              <p>Homemade recipes that will delight all your taste buds! Come in and try our delicious pastries for yourself!</p>
              <h5 style={{ textAlign: 'center', color: 'white', marginLeft: '10%', marginRight: '10%' }}><a style={{color: 'white', textDecoration: 'none'}}href="https://www.facebook.com/profile.php?id=100090372681441">Visit our Facebook Page - Little Heaven Café</a></h5>
            </div>
            <div className='col-1'>
      ...
      <br/>
      <br/>
      <h4 style={{ textAlign: 'center', color: 'darkorange' }}>We are open Thursday-Saturday from 12PM-6PM!</h4>
      <h4 style={{ textAlign: 'center', color: 'darkorange' }}>Thank you so much!</h4>
      <br/>
      <br/>
      <br/>
      <br/>
