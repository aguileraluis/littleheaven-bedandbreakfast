...
function Room({ room, fromdate, todate }) {
    ...
    return (
        <div key={room.name} style={{height: '100%', width: '100%', textAlign: 'center', marginBottom: '8px'}} className="row" data-aos='fade-up'>
            ...
            <Features style={{textAlign: 'center'}} image={room.imageurls[0]} imagetwo={room.imageurls[1]} roomname={room.name} type={room.type} roomdescriptiontwo={room.descriptiontwo} rentPerDay={room.rentPerDay} rentPerDay2={room.rentPerDay2} rentPerDay2Title={room.rentPerDay2Title} rentperday3={room.rentPerDay3} totalamount={room.totalamount} key={room.name}/>
